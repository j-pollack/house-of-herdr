...
- **Input Monitoring**, required: grant it to the app you run Herdr in
  (Ghostty, kitty, iTerm, ...).
- **Accessibility**, for global `{"key": ...}` bindings, system scrolling,
  and scrolling Codex's host-terminal transcript. Herdr-side bindings and
  Claude scrolling do not need it.
